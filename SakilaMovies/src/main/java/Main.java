        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            while (exit) {
                ...
                if (userSelection.equals("0")) {
                    ...
                    displayActorsWithLastName(connection, inputLastName);
                } else if (userSelection.equals("2")) {
                    System.out.println("Please enter a first name for actor: ");
                    String inputFirstName = scanner.nextLine();
                    System.out.println("Please enter a last name for actor: ");
                    String inputLastName = scanner.nextLine();
                    displayMoviesByActor(connection, inputFirstName, inputLastName);
                }
            }
